...
REFERENCE = RELEASE / "reference_outputs/main_figures_v1.2.0"
...
(PROJECT / "reproduction_result_v1.2.0.json").write_text(serialized, encoding="utf-8")
(EVIDENCE / "reproduction_result_v1.2.0.json").write_text(serialized, encoding="utf-8")
print(serialized)
